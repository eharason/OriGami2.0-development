...
.factory('GameData', function ($rootScope, $http, $filter, $q, Server) {
    ...
    data.getAllWaypoints = function(activityIndex) {
        savedPoints = game.activities[activityIndex].points;
        for (var point in savedPoints) {
            savedPointsLat = savedPoints[point].lat;
            savedPointsLng = savedPoints[point].lng;
            // console.log(savedPointsLat + savedPointsLng);
        }
        console.log(savedPointsLat);
    };
    // data.getNumWaypoints = function (activityIndex, waypoint) {
    //   savedPoints = game.activities[activityIndex].points;
    //   var inputWaypoint = {};
    //
    //   for (var point in savedPoints) {
    //       inputWaypoint.lat = savedPoints[point].lat;
    //       inputWaypoint.lng = savedPoints[point].lng;
    //       // console.log(savedPointsLat);
    //       // console.log(savedPointsLng);
    //       inputWaypoint.push(inputWaypoint);
    //   }
    //   console.log(inputWaypoint);
    //   return inputWaypoint;
    // };
    data.getNumWaypoints = function (activityIndex) {
      // TODO: change back?
      // console.log(game.activities[activityIndex].points);
        if (loaded) {
